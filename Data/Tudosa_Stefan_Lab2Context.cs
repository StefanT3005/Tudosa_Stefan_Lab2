...
namespace Tudosa_Stefan_Lab2.Data
{
    public class Tudosa_Stefan_Lab2Context : DbContext
    {
        ...
        public DbSet<Tudosa_Stefan_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Tudosa_Stefan_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Tudosa_Stefan_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
